...
.nav-bar {
    li {
        a {
            @apply uppercase text-[#ddd] text-xs tracking-wide font-medium px-3;
            &:hover,
            &.active {
                color: #fff;
                @apply font-semibold
...
.offcanvas-right {
    ul {
        @apply fixed md:static top-0 right-0 bg-white md:bg-transparent p-5 w-60 md:w-full pt-16 md:pt-0 h-full;
        a {
